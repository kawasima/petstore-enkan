...
import petstore.controller.CategoryController;
 ...
 * @author kawasima
 */
public class PetstoreApplicationFactory implements ApplicationFactory {
    @Override
    public Application create(ComponentInjector injector) {
        ...
        Routes routes = Routes.define(r -> {
            r.get("/category").to(CategoryController.class, "findAll");
            r.post("/category").to(CategoryController.class, "create");
        }).compile();
